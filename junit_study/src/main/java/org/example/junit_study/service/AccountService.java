...
import org.example.junit_study.domain.transaction.TransactionEnum;
...
import org.example.junit_study.dto.Account.AccountReqDto;
import org.example.junit_study.dto.Account.AccountRespDto;
import org.example.junit_study.dto.Account.AccountRespDto.*;
...
public class AccountService {
    ...
    public AccountRespDto.AccountListRespDto 계좌목록보기_유저별(Long userId) {
    ...
    // 인증이 필요 없다.
    @Transactional
    public AccountDepositRespDto 계좌입금(AccountReqDto.AccountDepositReqDto accountDepositReqDto) { // ATM -> 누군가의 계좌
        // 0원 체크
